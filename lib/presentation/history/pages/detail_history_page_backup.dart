...
class DetailHistoryPageBackup extends StatefulWidget {
  final Attendance attendance;

  const DetailHistoryPageBackup({super.key, required this.attendance});

  @override
  State<DetailHistoryPageBackup> createState() => _DetailHistoryPageBackupState();
}

class _DetailHistoryPageBackupState extends State<DetailHistoryPageBackup> {
